...
<form method="post" action="/user/register" autocomplete="off">
  ...
  <input class="u-hp" type="text" name="website" tabindex="-1" autocomplete="off" aria-hidden="true">
  <div class="u-field">
    <label>用户名 *</label>
    <input class="u-in" type="text" name="username" value="{U}" maxlength="20" placeholder="2 ~ 20 位，支持中文" required>
    <div class="tip">登录用，注册后不可修改。</div>
  </div>
  <div class="u-field">
    <label>邮箱（选填）</label>
    <input class="u-in" type="email" name="email" value="{E}" maxlength="128" placeholder="便于找回密码，可不填">
  </div>
  <div class="u-row2">
    <div class="u-field">
      <label>密码 *</label>
...
<form method="post" action="/user/login" autocomplete="off">
  ...
  <div class="u-field">
    <label>用户名</label>
    <input class="u-in" type="text" name="username" value="{U}" maxlength="20" autocomplete="username" required>
  </div>
  <div class="u-field">
    <label>密码</label>
