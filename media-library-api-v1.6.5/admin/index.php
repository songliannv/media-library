...
<div class="wrap">
  ...
  <div id="initGuide" class="card" style="display:none">
    <h3 style="margin:0 0 10px">🔐 尚未配置管理令牌</h3>
    <p style="color:var(--mut);font-size:13.5px;line-height:1.9;margin:0 0 12px">
      请先完成以下两步，否则所有后台功能都无法使用：
    </p>
    <ol style="margin:0 0 14px 20px;color:var(--mut);font-size:13.5px;line-height:2">
      <li>打开 <code>config/config.php</code>，找到 <code>'admin' => [</code> 段，把 <code>'token'</code> 的值改成你的随机字符串（建议 32 位以上字母数字）。</li>
      <li>回到本页面，在上方输入框粘贴该字符串，点<b>「保存」</b>。</li>
    </ol>
    <p style="color:var(--mut);font-size:12.5px;line-height:1.8">
      💡 <b>生成强令牌</b>：在服务器终端运行
      <code style="background:var(--cbg);padding:2px 6px;border-radius:4px">
    ...
    <p style="color:var(--mut);font-size:12px;margin-top:10px">
      配置完成后刷新本页面即可进入后台。
      令牌只存在你本地浏览器的 <code>localStorage</code>，不会上传到任何服务器。
    </p>
  </div>
