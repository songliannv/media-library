...
<div class="wrap">
  ...
  <div class="hero">
    ...
    <h1>媒资资料库 · <?php echo $DONE?'安装完成':'网页安装向导';?> <span class="ver">v<?php echo defined('ML_APP_VERSION')?ML_APP_VERSION:'2.1.3';?></span></h1>
